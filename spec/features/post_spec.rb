...
describe 'navigate' do
  before do
    @author = Author.create(name: "Stephen Hawking", hometown: "Fiji")
    @post = Author.first.posts.create(title: "My Post", description: "My post desc", author_id: 1)
  end
...
describe 'form' do
  it 'shows a new form that submits content and redirects and prints out params' do
    Author.create(name: "Stephen HahahaKing", hometown: "The Universe")
    
    visit new_post_path

    fill_in 'post_title', with: "My post title"
    fill_in 'post_description', with: "My post description"
    fill_in 'post_author_id', with: 1
  ...
  it 'shows an edit form that submits content and redirects and prints out params' do
    Author.create(name: "Stephen HahahaKing", hometown: "The Universe")
    @post = Author.first.posts.create(title: "My Post", description: "My post desc")
