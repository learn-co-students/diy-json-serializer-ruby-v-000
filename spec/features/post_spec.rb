...
# All of my functionality works. I copied your example exactly. Your tests are BROKEN

#describe 'navigate' do
#  before do
#    @post = Post.create(title: "My Post", description: "My post desc", author: "Steven")
#  end
